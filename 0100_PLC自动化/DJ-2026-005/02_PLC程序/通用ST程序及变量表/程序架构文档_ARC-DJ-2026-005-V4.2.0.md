...
graph TD
    subgraph 主控程序
        Main[PRG_MainControl_DJ2026005]
    end
    ...
    subgraph 工站功能块
        ...
        External[FB_ExternalDeviceInteraction]
    end
...
| FB_ExternalDeviceInteraction | FUNCTION_BLOCK | 外部设备交互(组框机/打胶机/机器人) | [external/FB_ExternalDeviceInteraction.scl](external/FB_ExternalDeviceInteraction.scl) |
| FB_1001_Conveyor4Layer_BufferFraming | FUNCTION_BLOCK | 4层独立分料/输送控制(容器块) | [conveyor/FB_1001_Conveyor4Layer_BufferFraming.scl](conveyor/FB_1001_Conveyor4Layer_BufferFraming.scl) |
| FB_1002_SingleLayerConveyor_BufferFraming | FUNCTION_BLOCK | 单层输送机控制(被FB_1001实例化) | [conveyor/FB_1002_SingleLayerConveyor_BufferFraming.scl](conveyor/FB_1002_SingleLayerConveyor_BufferFraming.scl) |
| FB_1003_PickPlace_BufferFraming | FUNCTION_BLOCK | Z轴升降+X1轴横移+夹爪控制(11步状态机) | [pickplace/FB_1003_PickPlace_BufferFraming.scl](pickplace/FB_1003_PickPlace_BufferFraming.scl) |
| FB_1004_GlueMachineFeeder_BufferFraming | FUNCTION_BLOCK | X2轴横移+打胶机交互(6步状态机) | [feeder/FB_1004_GlueMachineFeeder_BufferFraming.scl](feeder/FB_1004_GlueMachineFeeder_BufferFraming.scl) |
| FB_2001_CommonAlarm_AllStation | FUNCTION_BLOCK | 三站报警汇总+全局报警字+MES队列 | [common/FB_2001_CommonAlarm_AllStation.scl](common/FB_2001_CommonAlarm_AllStation.scl) |
...
│   └── [配套文档 x4]
├── [全局规范文档]              # 根目录,带版本号
│   ├── 程序架构文档_ARC-DJ-2026-005-V4.2.0.md        ← 本文档
│   ├── PLC变量定义文档_VAR-DJ-2026-005-V4.2.0.md
│   └── 详细设计说明书_DSN-DJ-2026-005-V4.2.0.md
...
| 全局规范文档 | `{类型}_{ID}-V{版本}.md` | `程序架构文档_ARC-DJ-2026-005-V4.2.0.md` |
...
| 变量定义文档 | 变量定义和说明 | [PLC变量定义文档_VAR-DJ-2026-005-V4.2.0.md](PLC变量定义文档_VAR-DJ-2026-005-V4.2.0.md) |
| 详细设计说明书 | 项目级设计说明 | [详细设计说明书_DSN-DJ-2026-005-V4.2.0.md](详细设计说明书_DSN-DJ-2026-005-V4.2.0.md) |
