...
| **编制人** | Trae |
| **审核人** | [待审核] |
| **遵循规范** | 810_PLC编程规范_DEV-V1.0.2, 801_PLC变量命名与功能块命名规范_DEV-V1.0.5 |
...
| 文档名称 | 路径 | 说明 |
|---------|:-----|:-----|
| PLC程序设计总文档 | `../../程序文档/016_DJ-2026-005_PLC程序设计总文档_PLC-V2.0.0.md` | 整体架构说明 |
| PLC变量定义文档 | `../../程序文档/PLC变量定义文档_VAR-DJ-2026-005-V2.0.0.md` | 全局D/M区变量定义(含D120/D400/D404/M200等) |
