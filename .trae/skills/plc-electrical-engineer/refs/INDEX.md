...
1. 先判定任务类型（Bug修复/功能开发/架构重写/规范检查/熟悉分析/单元测试）与对象（气缸/真空/输送/状态机/报警联锁等）。
...
| `siemens-lsp-and-testing.md` | 扩展配置(.plc.json)/SCL代码规避/.scltest单元测试/FBD描述 | Dynamic Siemens Support 扩展适配、.scltest DSL 测试编写与 LSP 规则 |
