...
def test_substance_checker_catches_placeholders():
...
def test_substance_checker_passes_on_full_substance():
...
def test_transition_guard_blocks_empty_substance():
...
def test_substance_injector_replaces_placeholders(tmp_path: Path):
