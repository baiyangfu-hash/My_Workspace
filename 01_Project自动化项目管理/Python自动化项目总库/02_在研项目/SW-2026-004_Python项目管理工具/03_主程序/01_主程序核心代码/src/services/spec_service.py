...
项目根目录/
├── 00_项目基础信息/          # 项目基础信息
│   └── 0-项目立项表_PROJ-V1.0.0.md
├── 01_项目文档/              # 项目文档
│   ├── 1-需求分析文档_REQ-V1.0.0.md
│   ├── 2-详细设计说明书_DES-V1.0.0.md
│   └── 3-接口文档_INT-V1.0.0.md
├── 03_主程序/                # 主程序
│   └── 01_主程序核心代码/
│       ├── src/              # 源代码
│       ├── tests/            # 测试代码
...
- 格式：`序号-文档名称_类型-版本号.md`
- 示例：`1-需求分析文档_REQ-V1.0.0.md`
...
| 文档类型 | 编号前缀 | 示例 |
|---------|---------|------|
| 项目立项表 | PROJ | 0-项目立项表_PROJ-V1.0.0.md |
| 需求分析文档 | REQ | 1-需求分析文档_REQ-V1.0.0.md |
| 详细设计说明书 | DES | 2-详细设计说明书_DES-V1.0.0.md |
| 接口文档 | INT | 3-接口文档_INT-V1.0.0.md |
| 测试用例 | TEST | 4-测试用例_TEST-V1.0.0.md |
| 使用文档 | USE | 5-使用文档_USE-V1.0.0.md |
