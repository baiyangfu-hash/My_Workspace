...
class TestGetProjectPathPrefixMatch:
    ...
    def test_prefix_match_project_id_underscore_name(self, workspace: str, tmp_path) -> None:
    ...
    def test_prefix_match_with_chinese_name(self, workspace: str, tmp_path) -> None:
    ...
    def test_prefix_match_with_special_chars(self, workspace: str, tmp_path) -> None:
    ...
    def test_prefix_match_with_long_name(self, workspace: str, tmp_path) -> None:
...
class TestGetProjectPathExactMatch:
    ...
    def test_exact_match(self, workspace: str, tmp_path) -> None:
    ...
    def test_exact_match_takes_priority(self, workspace: str, tmp_path) -> None:
...
class TestGetProjectPathNoFalseMatch:
    ...
    def test_no_false_match_similar_id(self, workspace: str, tmp_path) -> None:
    ...
    def test_no_false_match_partial_id(self, workspace: str, tmp_path) -> None:
    ...
    def test_nonexistent_workspace(self, tmp_path) -> None:
        """工作空间目录不存在时返回 None"""
...
class TestGetProjectPathIntegration:
    ...
    def test_list_changes_with_prefix_named_project(self, workspace: str, tmp_path) -> None:
