...
class TestLaunch:
    ...
    def test_window_title(self, main_window: MainWindow, app: QApplication) -> None:
        """验证窗口标题为 'auto-pm 项目管理工具'"""
        assert_window_title(main_window, "auto-pm 项目管理工具")

    def test_window_size(self, main_window: MainWindow, app: QApplication) -> None:
    ...
    def test_statusbar_initialized(self, main_window: MainWindow, app: QApplication) -> None:
        """验证状态栏 _status_workspace 文本含 '工作空间'"""
        assert_statusbar_contains(main_window, "workspace", "工作空间")

    def test_nav_tree_exists(self, main_window: MainWindow, app: QApplication) -> None:
        """验证导航树 _nav_tree 不为 None"""
        assert main_window._nav_tree is not None, "导航树 _nav_tree 为 None"

    def test_project_list_view_exists(self, main_window: MainWindow, app: QApplication) -> None:
        """验证项目列表视图 _project_list_view 不为 None"""
        assert main_window._project_list_view is not None, (
            "项目列表视图 _project_list_view 为 None"
        )

    def test_stack_has_pages(self, main_window: MainWindow, app: QApplication) -> None:
