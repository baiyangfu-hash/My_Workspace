...
Rectangle {
    ...
    function onLedgerChangeSelected(changeNumber) {
        root.viewMode = "split"
        root.loadChangeDetail(changeNumber)
    }
    ...
    function onDetailStatusChanged() {
        ...
        if (root.selectedChangeNumber !== "") {
            root.loadChangeDetail(root.selectedChangeNumber)
        }
    }
    ...
    StackLayout {
        ...
        LedgerTableView {
            ...
            onChangeSelected: root.onLedgerChangeSelected(model.change_number || "")
        }
    }
