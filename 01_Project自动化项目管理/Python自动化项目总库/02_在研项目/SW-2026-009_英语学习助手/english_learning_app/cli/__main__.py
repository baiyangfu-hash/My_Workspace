"""english-learning-app CLI 主入口

Usage:
    english-learning-app --help
    english-learning-app hello
"""
...
def hello(ctx: click.Context) -> None:
    """示例命令：打印欢迎信息"""
    app_ctx: AppContext = ctx.obj
    console.print("[green]Hello from 英语学习助手![/green]")
