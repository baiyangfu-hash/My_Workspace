...
当前版本在既有工具基础上开始增强对 `DJ` 单机项目的治理支持，重点面向类似 `DJ-2026-005` 的项目目录、PLC源码、变更管理、测试与交付资产进行统一识别和管理。
...
- 项目类型：新增 `DJ_SINGLE_MACHINE` 项目识别模型，用于导入和管理现有 DJ 单机项目。
- 资产识别：扫描 `00_项目管理`、`02_PLC程序`、`03_HMI设计`、`04_现场调试`、`06_文档与交付`、`10_知识库` 等核心资产。
- 忽略规则：项目治理扫描时默认忽略 `.trae`、`.plc-out`、`.git`、`__pycache__`。
- 文档原则：文档操作遵循“文档先行 + 不重复新增同类文档”，优先更新现有权威文档。
- 变更管理：以 `00_项目管理/04_变更管理` 为变更权威源，后续工作流和门禁均围绕该目录展开。
...
| **总计划与里程碑** | [01_项目文档/02_规划过程/006_总计划与里程碑_PLAN-V1.0.0.md](01_项目文档/02_规划过程/006_总计划与里程碑_PLAN-V1.0.0.md) | 版本里程碑与Sprint总表（权威口径） |
| **执行进度跟踪** | [01_项目文档/03_执行过程/README.md](01_项目文档/03_执行过程/README.md) | Sprint进度/功能状态/测试统计 |
| 用户操作手册 | [01_项目文档/03_执行过程/05_用户手册/012_用户操作手册_UM-V2.0.0.md](01_项目文档/03_执行过程/05_用户手册/012_用户操作手册_UM-V2.0.0.md) | 功能使用说明 |
| 代码结构说明 | [01_项目文档/02_规划过程/010_代码结构说明_DEV-V1.0.0.md](01_项目文档/02_规划过程/010_代码结构说明_DEV-V1.0.0.md) | 目录与文件职责 |
| 环境搭建指南 | [01_项目文档/02_规划过程/011_开发环境搭建指南_DEV-V1.0.0.md](01_项目文档/02_规划过程/011_开发环境搭建指南_DEV-V1.0.0.md) | 开发环境配置 |
