# Python项目管理工具测试报告
> 测试时间: 2026-04-12T07:35:05.950159
> 完成时间: 2026-04-12T07:35:08.486229
...
- **Python项目检测**: ✅ 通过
  ...
  - 执行时间: 0.000秒
- **项目构建测试**: ✅ 通过
  - 详情: 构建结果: C:\Users\fubai\AppData\Local\Temp\tmp39sxs0hl\python_project_manager-2.1.0-py3-none-any.whl
  - 执行时间: 1.036秒
...
| 2 | 性能测试 | 启动时间 | [WinError 225] 无法成功完成操作，因为文件包含病毒或潜在的垃圾软件。 |
