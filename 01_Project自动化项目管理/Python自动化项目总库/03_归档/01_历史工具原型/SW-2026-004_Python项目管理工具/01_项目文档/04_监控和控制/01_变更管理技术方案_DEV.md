...
| [040_通用变更单模板](../../../00_Obsidian_Base全局规范文件仓库/04_监控和控制/01_变更管理/02_变更单模板/040_通用变更单模板_CHG.md) | V2.0.0 | 变更单模板格式(§1~§10) |
| [041_通用版本变更台帐模板](../../../00_Obsidian_Base全局规范文件仓库/04_监控和控制/01_变更管理/04_变更记录/041_通用版本变更台帐模板_CHG.md) | V2.1.0 | 台帐引用模式格式 |
