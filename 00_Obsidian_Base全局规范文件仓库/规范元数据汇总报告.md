...
| `PM-045` | 045 | 变更管理流程执行指南 | V1.1.0 | 🟢stable | PM | `045_变更管理流程执行指南_PM-V1.1.0.md` |
...
| `LSP-903` | 903 | 定时器使用规范 | V1.0.0 | 🟢stable | LSP | `903_定时器使用规范_LSP-V1.0.0.md` |
| `LSP-904` | 904 | SCL注释规范 | V1.1.0 | 🟢stable | LSP | `904_SCL注释规范_LSP-V1.1.0.md` |
| `LSP-905` | 905 | SCL编程规范 | V1.0.1 | 🟢stable | LSP | `905_SCL编程规范_LSP-V1.0.1.md` |
| `LSP-906` | 906 | PLC编程错误预防规则 | V1.0.0 | 🟢stable | LSP | `906_错误预防规则_LSP-V1.0.0.md` |
| `LSP-907` | 907 | PLC项目配置规范 | V1.0.0 | 🟢stable | LSP | `907_项目配置规范_LSP-V1.0.0.md` |
| `TOOL-908` | 908 | Siemens Language Support插件使用指南 | V1.0.0 | 🟢stable | TOOL | `908_Siemens_Language_Support_使用指南_TOOL-V1.0.0.md` |
...
| `CODE-220` | 220 | Python项目打包规范 | V2.2.0 | 🟢stable | DEV | `220_Python项目打包规范_DEV-V2.2.0.md` |
...
| spec_id | 编号 | 标题 | 版本 | 生命周期 | 类型 | 文件名 |
|---------|------|------|------|----------|------|--------|
| `TOOL-906` | 906 | Mermaid图表工作流规范 | V2.0.0 | 🟢stable | TOOL | `906_Mermaid图表工作流规范_TOOL-V2.0.0.md` |

### 工具 (1个)

| spec_id | 编号 | 标题 | 版本 | 生命周期 | 类型 | 文件名 |
|---------|------|------|------|----------|------|--------|
| `SW-2026-006` | 006 | 规范管理工具 (SpecMgr) | V0.2.0 | 🟢stable | SW | `01-产品需求文档_PRD-V1.1.0.md` |
...
domain: pm
lifecycle: stable
canonical_path: "00_Obsidian_Base全局规范文件仓库/01_项目管理域/04_变更管理/045_变更管理流程执行指南_PM-V1.1.0.md"
type_prefix: PM
number: "045"
sub_domain: 04_变更管理
tags: ["变更管理", "执行指南"]
